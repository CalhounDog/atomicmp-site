    ...
    return (
      <div>
        ...
        <Container>
          ...
          <img src={arena} alt="" style={{"width":"100%"}} />
          <p>If you want to keep tabs on development updates and be the first to hear about build launches, join our <a className="discord-icon" href="https://discord.gg/5kPpTKw" target="_blank noopener noreferrer">Discord <i className="fab fa-discord"/></a>. From there, you can also get in touch with staff members and apply to become a Tester.</p>
        </Container>
        <div id="background"/>
      </div>
    );
